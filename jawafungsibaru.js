...
$(document).ready(function () {
  ...
  btn.className = "ico";
  var strHtml = '<a href="facebook://sharer/sharer.php?u=https://play.google.com/store/apps/details?id=sawa.ibnusta" target="_blank">';
  ...
  var btn = document.createElement("div");
  btn.className = "ico";
  var strHtml = '<a href="twitter://intent/tweet?text=https://play.google.com/store/apps/details?id=sawa.ibnusta" target="_blank">';
